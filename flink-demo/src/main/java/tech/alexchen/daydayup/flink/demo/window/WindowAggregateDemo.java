package tech.alexchen.daydayup.flink.demo.window;
...
import tech.alexchen.daydayup.flink.demo.functions.WaterSensorAggregateFunction;
...
public class WindowAggregateDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 聚合函数
        timeWindow.aggregate(new WaterSensorAggregateFunction()).print("TimeWindow result");
        env.execute();
    }
}
